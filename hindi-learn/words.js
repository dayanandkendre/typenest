...
const CURRENT="hindiWordsCurrentLevel";
const STARS="hindiWordsLevel";
const SCORE="hindiWordsLevel";
const BADGE="hindiWordsBadge";
const PROGRESS_FIELD="words";
const LEVEL_URL="wordslevel.html?id=";
