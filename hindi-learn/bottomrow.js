...
const CURRENT="hindiBottomrowCurrentLevel";
const STARS="hindiBottomrowLevel";
const SCORE="hindiBottomrowLevel";
const BADGE="hindiBottomrowBadge";
const PROGRESS_FIELD="bottomrow";
const LEVEL_URL="bottomrowlevel.html?id=";
